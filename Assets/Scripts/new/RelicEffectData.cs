...
namespace TacticalGame.Equipment
{
    ...
    Boots_V1_Captain,
    Boots_V2_Captain,
    Boots_V1_Quartermaster,
    Boots_V2_Quartermaster,
    Boots_V1_Helmsmaster,
    Boots_V2_Helmsmaster,
    Boots_V1_Boatswain,
    Boots_V2_Boatswain,
    Boots_V1_Shipwright,
    Boots_V2_Shipwright,
    Boots_V1_MasterGunner,
    Boots_V2_MasterGunner,
    Boots_V1_Navigator,
    Boots_V2_Navigator,
    Boots_V1_Surgeon,
    Boots_V2_Surgeon,
    Boots_V1_Cook,
    Boots_V2_Cook,
    Boots_V1_Swashbuckler,
    Boots_V2_Swashbuckler,
    Boots_V1_Deckhand,
    Boots_V2_Deckhand,
    Boots_V1_MasterAtArms,
    Boots_V2_MasterAtArms,
    // === NEW GLOVES V5.2 ===
        Gloves_V1_Captain,
        Gloves_V2_Captain,
        Gloves_V1_Quartermaster,
        Gloves_V2_Quartermaster,
        Gloves_V1_Helmsmaster,
        Gloves_V2_Helmsmaster,
        Gloves_V1_Boatswain,
        Gloves_V2_Boatswain,
        Gloves_V1_Shipwright,
        Gloves_V2_Shipwright,
        Gloves_V1_MasterGunner,
        Gloves_V2_MasterGunner,
        Gloves_V1_Navigator,
        Gloves_V2_Navigator,
        Gloves_V1_Surgeon,
        Gloves_V2_Surgeon,
        Gloves_V1_Cook,
        Gloves_V2_Cook,
        Gloves_V1_Swashbuckler,
        Gloves_V2_Swashbuckler,
        Gloves_V1_Deckhand,
        Gloves_V2_Deckhand,
        Gloves_V1_MasterAtArms,
        Gloves_V2_MasterAtArms,
    // === NEW HATS V5.2 ===
        Hat_V1_Captain,
        Hat_V2_Captain,
        Hat_V1_Quartermaster,
        Hat_V2_Quartermaster,
        Hat_V1_Helmsmaster,
        Hat_V2_Helmsmaster,
        Hat_V1_Boatswain,
        Hat_V2_Boatswain,
    ...
    // === NEW COATS V5.2 ===
        Coat_V1_Captain,
        Coat_V2_Captain,
        Coat_V1_Quartermaster,
        Coat_V2_Quartermaster,
        Coat_V1_Helmsmaster,
        Coat_V2_Helmsmaster,
        Coat_V1_Boatswain,
        Coat_V2_Boatswain,
        Coat_V1_Shipwright,
        Coat_V2_Shipwright,
        Coat_V1_MasterGunner,
        Coat_V2_MasterGunner,
        Coat_V1_MasterAtArms,
        Coat_V2_MasterAtArms,
        Coat_V1_Navigator,
        Coat_V2_Navigator,
        Coat_V1_Surgeon,
        Coat_V2_Surgeon,
        Coat_V1_Cook,
        Coat_V2_Cook,
        Coat_V1_Swashbuckler,
        Coat_V2_Swashbuckler,
        Coat_V1_Deckhand,
        Coat_V2_Deckhand,
    // === NEW TRINKETS V5.2 ===
        Trinket_V1_Captain,
        Trinket_V2_Captain,
        Trinket_V1_Quartermaster,
        Trinket_V2_Quartermaster,
        Trinket_V1_Helmsmaster,
        Trinket_V2_Helmsmaster,
        Trinket_V1_Boatswain,
        Trinket_V2_Boatswain,
        Trinket_V1_Shipwright,
        Trinket_V2_Shipwright,
        Trinket_V1_MasterGunner,
        Trinket_V2_MasterGunner,
        Trinket_V1_MasterAtArms,
        Trinket_V2_MasterAtArms,
        Trinket_V1_Navigator,
        Trinket_V2_Navigator,
        Trinket_V1_Surgeon,
        Trinket_V2_Surgeon,
        Trinket_V1_Cook,
        Trinket_V2_Cook,
        Trinket_V1_Swashbuckler,
        Trinket_V2_Swashbuckler,
        Trinket_V1_Deckhand,
        Trinket_V2_Deckhand,
    // === NEW TOTEMS V5.2 ===
        Totem_V1_Captain,
        Totem_V2_Captain,
        Totem_V1_Quartermaster,
        Totem_V2_Quartermaster,
        Totem_V1_Helmsmaster,
        Totem_V2_Helmsmaster,
        Totem_V1_Boatswain,
        Totem_V2_Boatswain,
        Totem_V1_Shipwright,
        Totem_V2_Shipwright,
        Totem_V1_MasterGunner,
        Totem_V2_MasterGunner,
        Totem_V1_MasterAtArms,
        Totem_V2_MasterAtArms,
        Totem_V1_Navigator,
        Totem_V2_Navigator,
        Totem_V1_Surgeon,
        Totem_V2_Surgeon,
        Totem_V1_Cook,
        Totem_V2_Cook,
        Totem_V1_Swashbuckler,
        Totem_V2_Swashbuckler,
        Totem_V1_Deckhand,
        Totem_V2_Deckhand,
    // === NEW ULTIMATES V5.2 ===
        Ultimate_V1_Captain,
        Ultimate_V2_Captain,
        Ultimate_V1_Quartermaster,
        Ultimate_V2_Quartermaster,
        Ultimate_V1_Helmsmaster,
        Ultimate_V2_Helmsmaster,
        Ultimate_V1_Boatswain,
        Ultimate_V2_Boatswain,
        Ultimate_V1_Shipwright,
        Ultimate_V2_Shipwright,
        Ultimate_V1_MasterGunner,
        Ultimate_V2_MasterGunner,
        Ultimate_V1_MasterAtArms,
        Ultimate_V2_MasterAtArms,
        Ultimate_V1_Navigator,
        Ultimate_V2_Navigator,
        Ultimate_V1_Surgeon,
        Ultimate_V2_Surgeon,
        Ultimate_V1_Cook,
        Ultimate_V2_Cook,
        Ultimate_V1_Swashbuckler,
        Ultimate_V2_Swashbuckler,
        Ultimate_V1_Deckhand,
        Ultimate_V2_Deckhand,
    // === NEW PASSIVES V5.2 ===
        PassiveUnique_V1_Captain,
        PassiveUnique_V2_Captain,
        PassiveUnique_V1_Quartermaster,
        PassiveUnique_V2_Quartermaster,
        PassiveUnique_V1_Helmsmaster,
        PassiveUnique_V2_Helmsmaster,
        PassiveUnique_V1_Boatswain,
        PassiveUnique_V2_Boatswain,
        PassiveUnique_V1_Shipwright,
        PassiveUnique_V2_Shipwright,
        PassiveUnique_V1_MasterGunner,
        PassiveUnique_V2_MasterGunner,
        PassiveUnique_V1_MasterAtArms,
        PassiveUnique_V2_MasterAtArms,
        PassiveUnique_V1_Navigator,
        PassiveUnique_V2_Navigator,
        PassiveUnique_V1_Surgeon,
        PassiveUnique_V2_Surgeon,
        PassiveUnique_V1_Cook,
        PassiveUnique_V2_Cook,
        PassiveUnique_V1_Swashbuckler,
        PassiveUnique_V2_Swashbuckler,
        PassiveUnique_V1_Deckhand,
        PassiveUnique_V2_Deckhand,
    }
}